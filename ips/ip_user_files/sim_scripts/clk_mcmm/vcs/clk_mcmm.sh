...
#                script (type 'clk_mcmm.sh -help' for more information).
#
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.clk_mcmm xil_defaultlib.glbl -o clk_mcmm_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./clk_mcmm_simv $vcs_sim_opts -do simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/b83c/fpga/rv32/ips/managed_ip_project/managed_ip_project.cache/compile_simlib/vcs"
  fi
...
reset_run()
{
  files_to_remove=(ucli.key clk_mcmm_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc clk_mcmm_simv.daidir vcs_lib c.obj)
