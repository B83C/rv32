...
#
# Script generated by Vivado on Mon Jan 06 15:09:56 +08 2025
# SW Build 5239630 on Fri Nov 08 22:34:34 MST 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : clk_mcmm.sh
...
#
# Usage        : clk_mcmm.sh
#                clk_mcmm.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                clk_mcmm.sh [-reset_run]
#                clk_mcmm.sh [-reset_log]
#                clk_mcmm.sh [-help]
#
...
export RDI_DATADIR="/home/b83c/tools/Xilinx/Vivado/2024.2/data"

# set xvlog options
xvlog_opts="--incr --relax "

# script info
echo -e "clk_mcmm.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./clk_mcmm.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot clk_mcmm xil_defaultlib.clk_mcmm xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim clk_mcmm -key {Behavioral:sim_1:Functional:clk_mcmm} -tclbatch cmd.tcl -log simulate.log
}
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/b83c/tools/Xilinx/Vivado/2024.2/data/xsim"
  fi
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb clk_mcmm.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./clk_mcmm.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: clk_mcmm.sh [-help]\n\
Usage: clk_mcmm.sh [-step]\n\
Usage: clk_mcmm.sh [-lib_map_path]\n\
Usage: clk_mcmm.sh [-reset_run]\n\
Usage: clk_mcmm.sh [-reset_log]\n\
Usage: clk_mcmm.sh [-keep_index]\n\
Usage: clk_mcmm.sh [-noclean_files]\n\n\
